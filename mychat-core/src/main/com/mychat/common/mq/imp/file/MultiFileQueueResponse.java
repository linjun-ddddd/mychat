...
public class MultiFileQueueResponse extends AbstractQueueResponse<File> {

	public MultiFileQueueResponse(ResponseConfig responseConfig) {
	...
	@Override
	protected File receive(QueueReceiver receiver) throws JMSException {
