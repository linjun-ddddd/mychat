...
public class MultiXmlResponse extends AbstractNormalResponse<Document> {


	public MultiXmlResponse(ResponseConfig responseConfig) {
		// TODO Auto-generated constructor stub
		this.responseConfig=responseConfig;
	}

	@Override
	protected Document receive(MessageConsumer consumer) throws JMSException {
		// TODO Auto-generated method stub
		TextMessage message = (TextMessage) consumer.receive(responseConfig.getTimeOut());
