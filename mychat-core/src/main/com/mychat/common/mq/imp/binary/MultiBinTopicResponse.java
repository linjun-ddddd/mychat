...
public class MultiBinTopicResponse extends AbstractTopicResponse<byte[]> {

	public MultiBinTopicResponse() {
		// TODO Auto-generated constructor stub
		System.setProperty("org.apache.activemq.SERIALIZABLE_PACKAGES", "com.alibaba.fastjson,java.util,java.io");
	}

	public MultiBinTopicResponse(ResponseConfig responseConfig) {
		// TODO Auto-generated constructor stub
		this.responseConfig=responseConfig;
	}

	@Override
	protected byte[] receive(TopicSubscriber subscriber) throws JMSException {
		// TODO Auto-generated method stub
		BytesMessage message = (BytesMessage) subscriber.receive(responseConfig.getTimeOut());
		if (message != null) {
